...
export default function OverviewPage() {
  const services = [
  {
    ...
    "desc": "Native iOS & Android apps designed for engagement.",
    "href": "/app-development-goa/mobile-app-development",
    "icon": "Smartphone"
  },
  {
    "title": "Web App Development",
    "desc": "Feature-rich interactive applications in the browser.",
    "href": "/app-development-goa/web-app-development",
    "icon": "Globe"
  },
  {
    "title": "SaaS Product Development",
    "desc": "Scalable software-as-a-service MVPs & platforms.",
    "href": "/app-development-goa/saas-product-development",
    "icon": "Layers"
  },
  {
    "title": "CRM & Dashboard Development",
    "desc": "Custom panels for data tracking and client operations.",
    "href": "/app-development-goa/crm-dashboard-development",
    "icon": "BarChart3"
  },
  {
    "title": "Online Booking Systems",
    "desc": "Seamless appointment and scheduling reservation engines.",
    "href": "/app-development-goa/online-booking-systems",
    "icon": "Calendar"
  },
  {
    "title": "Custom Admin Panels",
    "desc": "Secure internal hubs for content and order management.",
    "href": "/app-development-goa/custom-admin-panels",
    "icon": "Settings"
  },
  {
    "title": "Customer Portals",
    "desc": "Private client portals for secure sharing and communication.",
    "href": "/app-development-goa/customer-portals",
    "icon": "Users"
  }
];
  const title = "App Development Goa";
  const eyebrow = "App Development Goa";
  const description = "Custom mobile and web applications with seamless performance and premium UI/UX.";
  const iconImg = "/images/service_app_v5.png";
          ...
          <div className="max-w-7xl mx-auto px-6 relative z-10 w-full grid grid-cols-1 lg:grid-cols-12 gap-8">
            <div className="lg:col-span-8 space-y-6 text-left">
              ...
              <p className="text-[#0F2C59]/80 text-base sm:text-lg leading-relaxed max-w-xl">
                Custom mobile and web applications with seamless performance and premium UI/UX.
              </p>

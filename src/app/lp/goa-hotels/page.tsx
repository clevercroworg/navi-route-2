        ...
        <div className="col-span-12 lg:col-span-7 p-6 sm:p-8 flex flex-col justify-between z-10">
          <div>
            ...
            <div className="flex items-center gap-3 mb-2 flex-wrap">
              ...
              <div className="flex items-center gap-1.5 bg-white text-navy-800 text-[10px] font-bold px-3 py-1 rounded-full border border-slate-200/80 shadow-xs">
                ...
                <div className="flex items-center gap-0.5 ml-1 border-l border-slate-200 pl-1.5">
                  {Array.from({ length: 5 }, (_, i) => {
                    ...
                    return (
                      <Star 
                        key={i} 
                        className={`w-2.5 h-2.5 shrink-0 ${isFilled ? "fill-[#FF6B00] text-[#FF6B00]" : "text-slate-200"}`} 
                      />
                    );
                  })}
                </div>

...
export default function OverviewPage() {
  const services = [
  {
    ...
    "desc": "Organic social strategy, creative posts, and community growth.",
    "href": "/digital-marketing-agency-goa/social-media-management",
    "icon": "Megaphone"
  },
  {
    "title": "Social Media Marketing",
    "desc": "Highly-targeted paid campaign funnels for quick growth.",
    "href": "/digital-marketing-agency-goa/social-media-marketing",
    "icon": "Target"
  },
  {
    "title": "Lead Generation Services",
    "desc": "End-to-end B2B & B2C acquisition campaigns that convert.",
    "href": "/digital-marketing-agency-goa/lead-generation-services",
    "icon": "TrendingUp"
  },
  {
    "title": "SEO Services",
    "desc": "Optimization of website copy and technical metrics for search.",
    "href": "/digital-marketing-agency-goa/seo-services",
    "icon": "Search"
  },
  {
    "title": "Performance Marketing (Meta & Google Ads)",
    "desc": "Optimized paid ads focusing purely on ROI & sales metrics.",
    "href": "/digital-marketing-agency-goa/performance-marketing-meta-google-ads",
    "icon": "Compass"
  },
  {
    "title": "Analytics & Conversion Tracking",
    "desc": "Custom GTM, GA4, and pixel configurations for attribution.",
    "href": "/digital-marketing-agency-goa/analytics-conversion-tracking",
    "icon": "LineChart"
  }
];
  const title = "Digital Marketing Agency Goa";
  const eyebrow = "Digital Marketing Agency Goa";
  const description = "Data-driven marketing campaigns designed to scale sales, leads, and brand engagement.";
  const iconImg = "/images/service_marketing_v5.png";
          ...
          <div className="max-w-7xl mx-auto px-6 relative z-10 w-full grid grid-cols-1 lg:grid-cols-12 gap-8">
            <div className="lg:col-span-8 space-y-6 text-left">
              ...
              <p className="text-[#0F2C59]/80 text-base sm:text-lg leading-relaxed max-w-xl">
                Data-driven marketing campaigns designed to scale sales, leads, and brand engagement.
              </p>

...
export default function OverviewPage() {
  const services = [
  {
    ...
    "desc": "Corporate and brand websites establishing authority.",
    "href": "/website-development-goa/business-websites",
    "icon": "Laptop"
  },
  {
    "title": "React / Next.js Development",
    "desc": "High-performance bespoke modern web applications.",
    "href": "/website-development-goa/react-nextjs-development",
    "icon": "Code2"
  },
  {
    "title": "Ecommerce Solutions",
    "desc": "Secure, scalable online stores with smooth checkout.",
    "href": "/website-development-goa/ecommerce-solutions",
    "icon": "ShoppingCart"
  },
  {
    "title": "Landing Page Design",
    "desc": "High-converting single-page funnels built for ad traffic.",
    "href": "/website-development-goa/landing-page-design",
    "icon": "Layout"
  },
  {
    "title": "Website Redesign",
    "desc": "Modern upgrades for legacy sites to improve user engagement.",
    "href": "/website-development-goa/website-redesign",
    "icon": "RefreshCw"
  },
  {
    "title": "Website Maintenance",
    "desc": "Reliable updates, support, backups, and hosting management.",
    "href": "/website-development-goa/website-maintenance",
    "icon": "Wrench"
  }
];
  const title = "Website Development Goa";
  const eyebrow = "Website Development Goa";
  const description = "Custom high-performance websites engineered for speed, SEO, and business growth in Goa.";
  const iconImg = "/images/service_website_v5.png";
          ...
          <div className="max-w-7xl mx-auto px-6 relative z-10 w-full grid grid-cols-1 lg:grid-cols-12 gap-8">
            <div className="lg:col-span-8 space-y-6 text-left">
              ...
              <p className="text-[#0F2C59]/80 text-base sm:text-lg leading-relaxed max-w-xl">
                Custom high-performance websites engineered for speed, SEO, and business growth in Goa.
              </p>
